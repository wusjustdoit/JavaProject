...
public class CMDAO {
		...
		public void memberJoin(CMDTO chimac) {
			String sql = "INSERT INTO CHIMAC(CMID,CMPW, CMNAME, CMBIR,CMGEN,CMEMAIL,CMADR,CMPHONE) VALUES(?,?,?,?,?,?,?,?)";
		...
		// 입금 메소드
		public void deposit(CMDTO chimac) { 
		...
		// 출금 메소드
		public void withdraw(CMDTO chimac) { 
			String sql = "UPDATE CHIMAC SET CMBALANCE = CMBALANCE - ? WHERE CMID = ?";
