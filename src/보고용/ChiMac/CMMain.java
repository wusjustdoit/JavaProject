...
//									int pay = server.basketList2();
//									System.out.println("결제금액은 " + pay + "원 입니다. 결제하시겠습니까?");
//									System.out.println("1. 결제 | 2. 뒤로 가기");
//									int cpay = sc.nextInt();
//									switch(cpay) {
//									case 1 : 
//										if(cBalance >= pay) {
...
//										} else {
//											System.out.println("잔액이 " + (cBalance - pay) + "원 부족합니다!");
//											System.out.println("현재 잔액은 " + cBalance + "원, 결제 요청금액은 " + pay + "원 입니다.");
//										break;
//									}
//										break;
//									case 2: 
							...
							case 2 : //출금
								...
								if(recheck) {
									...
									if(cBalance >= minusBalance) {
										...
										System.out.println("출금액이 " + (minusBalance - cBalance) + "원 부족합니다!");
